...
function HDH_ActionButton_ShowOverlayGlow(self)
	if ( self.overlay ) then
		...
		self.overlay:SetPoint("TOPLEFT", self, "TOPLEFT", -frameWidth * 0.27, frameHeight * 0.27);
		self.overlay:SetPoint("BOTTOMRIGHT", self, "BOTTOMRIGHT", frameWidth * 0.27, -frameHeight * 0.27);
		self.overlay.animIn:Play();
	end
end
